<?php
        ...
        $pagina = 'pagina' . 59 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 59, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 59 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (59 > 1) {
            echo '<a href="pagina' . (59 - 1) . '.php">Página anterior</a>';
        }
        if (59 < 100) {
            echo ' | <a href="pagina' . (59 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
