<?php
        ...
        $pagina = 'pagina' . 54 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 54, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 54 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (54 > 1) {
            echo '<a href="pagina' . (54 - 1) . '.php">Página anterior</a>';
        }
        if (54 < 100) {
            echo ' | <a href="pagina' . (54 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
