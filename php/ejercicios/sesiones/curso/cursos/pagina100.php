<?php
        ...
        $pagina = 'pagina' . 100 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 100, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 100 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (100 > 1) {
            echo '<a href="pagina' . (100 - 1) . '.php">Página anterior</a>';
        }
        if (100 < 100) {
            echo ' | <a href="pagina' . (100 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
