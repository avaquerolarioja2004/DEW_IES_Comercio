<?php
        ...
        $pagina = 'pagina' . 83 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 83, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 83 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (83 > 1) {
            echo '<a href="pagina' . (83 - 1) . '.php">Página anterior</a>';
        }
        if (83 < 100) {
            echo ' | <a href="pagina' . (83 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
