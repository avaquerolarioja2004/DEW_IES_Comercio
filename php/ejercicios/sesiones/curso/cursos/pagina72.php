<?php
        ...
        $pagina = 'pagina' . 72 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 72, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 72 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (72 > 1) {
            echo '<a href="pagina' . (72 - 1) . '.php">Página anterior</a>';
        }
        if (72 < 100) {
            echo ' | <a href="pagina' . (72 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
