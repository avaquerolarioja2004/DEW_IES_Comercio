<?php
        ...
        $pagina = 'pagina' . 12 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 12, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 12 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (12 > 1) {
            echo '<a href="pagina' . (12 - 1) . '.php">Página anterior</a>';
        }
        if (12 < 100) {
            echo ' | <a href="pagina' . (12 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
