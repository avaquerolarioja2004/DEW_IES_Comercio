<?php
        ...
        $pagina = 'pagina' . 92 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 92, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 92 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (92 > 1) {
            echo '<a href="pagina' . (92 - 1) . '.php">Página anterior</a>';
        }
        if (92 < 100) {
            echo ' | <a href="pagina' . (92 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
