<?php
        ...
        $pagina = 'pagina' . 35 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 35, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 35 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (35 > 1) {
            echo '<a href="pagina' . (35 - 1) . '.php">Página anterior</a>';
        }
        if (35 < 100) {
            echo ' | <a href="pagina' . (35 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
