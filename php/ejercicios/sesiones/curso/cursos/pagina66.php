<?php
        ...
        $pagina = 'pagina' . 66 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 66, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 66 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (66 > 1) {
            echo '<a href="pagina' . (66 - 1) . '.php">Página anterior</a>';
        }
        if (66 < 100) {
            echo ' | <a href="pagina' . (66 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
