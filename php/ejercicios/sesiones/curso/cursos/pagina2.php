<?php
        ...
        $pagina = 'pagina' . 2 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 2, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 2 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (2 > 1) {
            echo '<a href="pagina' . (2 - 1) . '.php">Página anterior</a>';
        }
        if (2 < 100) {
            echo ' | <a href="pagina' . (2 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
