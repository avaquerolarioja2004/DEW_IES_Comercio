<?php
        ...
        $pagina = 'pagina' . 76 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 76, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 76 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (76 > 1) {
            echo '<a href="pagina' . (76 - 1) . '.php">Página anterior</a>';
        }
        if (76 < 100) {
            echo ' | <a href="pagina' . (76 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
