<?php
        ...
        $pagina = 'pagina' . 8 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 8, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 8 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (8 > 1) {
            echo '<a href="pagina' . (8 - 1) . '.php">Página anterior</a>';
        }
        if (8 < 100) {
            echo ' | <a href="pagina' . (8 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
