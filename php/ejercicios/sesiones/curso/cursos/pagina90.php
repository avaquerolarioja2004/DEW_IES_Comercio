<?php
        ...
        $pagina = 'pagina' . 90 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 90, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 90 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (90 > 1) {
            echo '<a href="pagina' . (90 - 1) . '.php">Página anterior</a>';
        }
        if (90 < 100) {
            echo ' | <a href="pagina' . (90 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
