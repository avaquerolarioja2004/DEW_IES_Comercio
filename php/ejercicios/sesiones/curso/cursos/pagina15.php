<?php
        ...
        $pagina = 'pagina' . 15 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 15, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 15 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (15 > 1) {
            echo '<a href="pagina' . (15 - 1) . '.php">Página anterior</a>';
        }
        if (15 < 100) {
            echo ' | <a href="pagina' . (15 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
