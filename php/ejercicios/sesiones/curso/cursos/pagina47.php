<?php
        ...
        $pagina = 'pagina' . 47 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 47, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 47 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (47 > 1) {
            echo '<a href="pagina' . (47 - 1) . '.php">Página anterior</a>';
        }
        if (47 < 100) {
            echo ' | <a href="pagina' . (47 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
