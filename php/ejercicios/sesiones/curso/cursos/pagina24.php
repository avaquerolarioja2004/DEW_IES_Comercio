<?php
        ...
        $pagina = 'pagina' . 24 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 24, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 24 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (24 > 1) {
            echo '<a href="pagina' . (24 - 1) . '.php">Página anterior</a>';
        }
        if (24 < 100) {
            echo ' | <a href="pagina' . (24 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
