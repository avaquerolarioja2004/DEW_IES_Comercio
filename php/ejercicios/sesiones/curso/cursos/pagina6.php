<?php
        ...
        $pagina = 'pagina' . 6 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 6, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 6 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (6 > 1) {
            echo '<a href="pagina' . (6 - 1) . '.php">Página anterior</a>';
        }
        if (6 < 100) {
            echo ' | <a href="pagina' . (6 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
