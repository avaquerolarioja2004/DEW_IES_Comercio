<?php
        ...
        $pagina = 'pagina' . 89 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 89, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 89 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (89 > 1) {
            echo '<a href="pagina' . (89 - 1) . '.php">Página anterior</a>';
        }
        if (89 < 100) {
            echo ' | <a href="pagina' . (89 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
