<?php
        ...
        $pagina = 'pagina' . 60 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 60, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 60 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (60 > 1) {
            echo '<a href="pagina' . (60 - 1) . '.php">Página anterior</a>';
        }
        if (60 < 100) {
            echo ' | <a href="pagina' . (60 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
