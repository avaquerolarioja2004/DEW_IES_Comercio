<?php
        ...
        $pagina = 'pagina' . 37 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 37, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 37 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (37 > 1) {
            echo '<a href="pagina' . (37 - 1) . '.php">Página anterior</a>';
        }
        if (37 < 100) {
            echo ' | <a href="pagina' . (37 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
