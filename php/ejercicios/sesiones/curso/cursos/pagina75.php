<?php
        ...
        $pagina = 'pagina' . 75 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 75, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 75 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (75 > 1) {
            echo '<a href="pagina' . (75 - 1) . '.php">Página anterior</a>';
        }
        if (75 < 100) {
            echo ' | <a href="pagina' . (75 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
