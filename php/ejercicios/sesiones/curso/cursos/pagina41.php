<?php
        ...
        $pagina = 'pagina' . 41 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 41, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 41 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (41 > 1) {
            echo '<a href="pagina' . (41 - 1) . '.php">Página anterior</a>';
        }
        if (41 < 100) {
            echo ' | <a href="pagina' . (41 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
