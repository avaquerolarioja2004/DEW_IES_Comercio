<?php
        ...
        $pagina = 'pagina' . 46 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 46, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 46 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (46 > 1) {
            echo '<a href="pagina' . (46 - 1) . '.php">Página anterior</a>';
        }
        if (46 < 100) {
            echo ' | <a href="pagina' . (46 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
