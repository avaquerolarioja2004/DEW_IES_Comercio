<?php
        ...
        $pagina = 'pagina' . 58 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 58, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 58 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (58 > 1) {
            echo '<a href="pagina' . (58 - 1) . '.php">Página anterior</a>';
        }
        if (58 < 100) {
            echo ' | <a href="pagina' . (58 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
