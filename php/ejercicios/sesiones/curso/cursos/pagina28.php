<?php
        ...
        $pagina = 'pagina' . 28 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 28, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 28 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (28 > 1) {
            echo '<a href="pagina' . (28 - 1) . '.php">Página anterior</a>';
        }
        if (28 < 100) {
            echo ' | <a href="pagina' . (28 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
