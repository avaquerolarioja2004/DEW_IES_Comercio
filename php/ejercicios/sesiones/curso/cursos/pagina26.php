<?php
        ...
        $pagina = 'pagina' . 26 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 26, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 26 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (26 > 1) {
            echo '<a href="pagina' . (26 - 1) . '.php">Página anterior</a>';
        }
        if (26 < 100) {
            echo ' | <a href="pagina' . (26 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
