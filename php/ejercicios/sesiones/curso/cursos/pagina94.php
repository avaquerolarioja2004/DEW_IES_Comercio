<?php
        ...
        $pagina = 'pagina' . 94 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 94, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 94 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (94 > 1) {
            echo '<a href="pagina' . (94 - 1) . '.php">Página anterior</a>';
        }
        if (94 < 100) {
            echo ' | <a href="pagina' . (94 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
