<?php
        ...
        $pagina = 'pagina' . 32 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 32, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 32 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (32 > 1) {
            echo '<a href="pagina' . (32 - 1) . '.php">Página anterior</a>';
        }
        if (32 < 100) {
            echo ' | <a href="pagina' . (32 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
