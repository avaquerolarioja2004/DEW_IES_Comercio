<?php
        ...
        $pagina = 'pagina' . 56 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 56, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 56 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (56 > 1) {
            echo '<a href="pagina' . (56 - 1) . '.php">Página anterior</a>';
        }
        if (56 < 100) {
            echo ' | <a href="pagina' . (56 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
