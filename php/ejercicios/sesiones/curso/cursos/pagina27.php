<?php
        ...
        $pagina = 'pagina' . 27 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 27, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 27 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (27 > 1) {
            echo '<a href="pagina' . (27 - 1) . '.php">Página anterior</a>';
        }
        if (27 < 100) {
            echo ' | <a href="pagina' . (27 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
