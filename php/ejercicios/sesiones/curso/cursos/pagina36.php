<?php
        ...
        $pagina = 'pagina' . 36 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 36, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 36 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (36 > 1) {
            echo '<a href="pagina' . (36 - 1) . '.php">Página anterior</a>';
        }
        if (36 < 100) {
            echo ' | <a href="pagina' . (36 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
