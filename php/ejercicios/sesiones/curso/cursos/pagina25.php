<?php
        ...
        $pagina = 'pagina' . 25 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 25, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 25 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (25 > 1) {
            echo '<a href="pagina' . (25 - 1) . '.php">Página anterior</a>';
        }
        if (25 < 100) {
            echo ' | <a href="pagina' . (25 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
