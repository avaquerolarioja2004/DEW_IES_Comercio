<?php
        ...
        $pagina = 'pagina' . 51 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 51, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 51 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (51 > 1) {
            echo '<a href="pagina' . (51 - 1) . '.php">Página anterior</a>';
        }
        if (51 < 100) {
            echo ' | <a href="pagina' . (51 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
