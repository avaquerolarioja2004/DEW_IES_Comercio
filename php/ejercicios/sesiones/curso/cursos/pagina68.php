<?php
        ...
        $pagina = 'pagina' . 68 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 68, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 68 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (68 > 1) {
            echo '<a href="pagina' . (68 - 1) . '.php">Página anterior</a>';
        }
        if (68 < 100) {
            echo ' | <a href="pagina' . (68 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
