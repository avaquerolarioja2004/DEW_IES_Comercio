<?php
        ...
        $pagina = 'pagina' . 70 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 70, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 70 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (70 > 1) {
            echo '<a href="pagina' . (70 - 1) . '.php">Página anterior</a>';
        }
        if (70 < 100) {
            echo ' | <a href="pagina' . (70 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
