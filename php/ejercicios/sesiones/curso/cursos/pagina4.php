<?php
        ...
        $pagina = 'pagina' . 4 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 4, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 4 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (4 > 1) {
            echo '<a href="pagina' . (4 - 1) . '.php">Página anterior</a>';
        }
        if (4 < 100) {
            echo ' | <a href="pagina' . (4 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
