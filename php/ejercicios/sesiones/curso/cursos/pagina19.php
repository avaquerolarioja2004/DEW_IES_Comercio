<?php
        ...
        $pagina = 'pagina' . 19 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 19, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 19 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (19 > 1) {
            echo '<a href="pagina' . (19 - 1) . '.php">Página anterior</a>';
        }
        if (19 < 100) {
            echo ' | <a href="pagina' . (19 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
