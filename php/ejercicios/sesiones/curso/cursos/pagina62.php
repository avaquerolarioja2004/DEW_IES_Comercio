<?php
        ...
        $pagina = 'pagina' . 62 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 62, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 62 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (62 > 1) {
            echo '<a href="pagina' . (62 - 1) . '.php">Página anterior</a>';
        }
        if (62 < 100) {
            echo ' | <a href="pagina' . (62 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
