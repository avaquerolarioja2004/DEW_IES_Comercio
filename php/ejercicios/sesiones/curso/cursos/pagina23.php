<?php
        ...
        $pagina = 'pagina' . 23 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 23, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 23 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (23 > 1) {
            echo '<a href="pagina' . (23 - 1) . '.php">Página anterior</a>';
        }
        if (23 < 100) {
            echo ' | <a href="pagina' . (23 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
