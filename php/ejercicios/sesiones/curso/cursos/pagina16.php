<?php
        ...
        $pagina = 'pagina' . 16 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 16, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 16 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (16 > 1) {
            echo '<a href="pagina' . (16 - 1) . '.php">Página anterior</a>';
        }
        if (16 < 100) {
            echo ' | <a href="pagina' . (16 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
