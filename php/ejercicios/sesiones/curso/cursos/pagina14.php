<?php
        ...
        $pagina = 'pagina' . 14 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 14, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 14 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (14 > 1) {
            echo '<a href="pagina' . (14 - 1) . '.php">Página anterior</a>';
        }
        if (14 < 100) {
            echo ' | <a href="pagina' . (14 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
