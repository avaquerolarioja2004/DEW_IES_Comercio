<?php
        ...
        $pagina = 'pagina' . 87 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 87, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 87 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (87 > 1) {
            echo '<a href="pagina' . (87 - 1) . '.php">Página anterior</a>';
        }
        if (87 < 100) {
            echo ' | <a href="pagina' . (87 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
