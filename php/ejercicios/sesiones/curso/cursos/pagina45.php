<?php
        ...
        $pagina = 'pagina' . 45 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 45, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 45 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (45 > 1) {
            echo '<a href="pagina' . (45 - 1) . '.php">Página anterior</a>';
        }
        if (45 < 100) {
            echo ' | <a href="pagina' . (45 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
