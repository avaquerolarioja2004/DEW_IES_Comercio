<?php
        ...
        $pagina = 'pagina' . 20 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 20, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 20 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (20 > 1) {
            echo '<a href="pagina' . (20 - 1) . '.php">Página anterior</a>';
        }
        if (20 < 100) {
            echo ' | <a href="pagina' . (20 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
