<?php
        ...
        $pagina = 'pagina' . 29 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 29, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 29 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (29 > 1) {
            echo '<a href="pagina' . (29 - 1) . '.php">Página anterior</a>';
        }
        if (29 < 100) {
            echo ' | <a href="pagina' . (29 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
