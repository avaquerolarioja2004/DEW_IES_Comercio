<?php
        ...
        $pagina = 'pagina' . 44 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 44, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 44 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (44 > 1) {
            echo '<a href="pagina' . (44 - 1) . '.php">Página anterior</a>';
        }
        if (44 < 100) {
            echo ' | <a href="pagina' . (44 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
