<?php
        ...
        $pagina = 'pagina' . 82 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 82, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 82 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (82 > 1) {
            echo '<a href="pagina' . (82 - 1) . '.php">Página anterior</a>';
        }
        if (82 < 100) {
            echo ' | <a href="pagina' . (82 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
