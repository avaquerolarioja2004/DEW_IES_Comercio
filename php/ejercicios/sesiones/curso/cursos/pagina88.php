<?php
        ...
        $pagina = 'pagina' . 88 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 88, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 88 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (88 > 1) {
            echo '<a href="pagina' . (88 - 1) . '.php">Página anterior</a>';
        }
        if (88 < 100) {
            echo ' | <a href="pagina' . (88 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
