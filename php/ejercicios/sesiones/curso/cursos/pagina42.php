<?php
        ...
        $pagina = 'pagina' . 42 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 42, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 42 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (42 > 1) {
            echo '<a href="pagina' . (42 - 1) . '.php">Página anterior</a>';
        }
        if (42 < 100) {
            echo ' | <a href="pagina' . (42 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
