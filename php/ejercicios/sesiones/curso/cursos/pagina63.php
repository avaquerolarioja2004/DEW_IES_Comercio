<?php
        ...
        $pagina = 'pagina' . 63 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 63, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 63 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (63 > 1) {
            echo '<a href="pagina' . (63 - 1) . '.php">Página anterior</a>';
        }
        if (63 < 100) {
            echo ' | <a href="pagina' . (63 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
