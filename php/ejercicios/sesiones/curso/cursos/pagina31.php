<?php
        ...
        $pagina = 'pagina' . 31 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 31, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 31 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (31 > 1) {
            echo '<a href="pagina' . (31 - 1) . '.php">Página anterior</a>';
        }
        if (31 < 100) {
            echo ' | <a href="pagina' . (31 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
