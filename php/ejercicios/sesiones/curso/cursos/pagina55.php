<?php
        ...
        $pagina = 'pagina' . 55 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 55, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 55 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (55 > 1) {
            echo '<a href="pagina' . (55 - 1) . '.php">Página anterior</a>';
        }
        if (55 < 100) {
            echo ' | <a href="pagina' . (55 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
