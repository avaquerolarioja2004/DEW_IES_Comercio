<?php
        ...
        $pagina = 'pagina' . 40 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 40, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 40 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (40 > 1) {
            echo '<a href="pagina' . (40 - 1) . '.php">Página anterior</a>';
        }
        if (40 < 100) {
            echo ' | <a href="pagina' . (40 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
