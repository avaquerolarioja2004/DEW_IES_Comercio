<?php
        ...
        $pagina = 'pagina' . 13 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 13, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 13 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (13 > 1) {
            echo '<a href="pagina' . (13 - 1) . '.php">Página anterior</a>';
        }
        if (13 < 100) {
            echo ' | <a href="pagina' . (13 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
