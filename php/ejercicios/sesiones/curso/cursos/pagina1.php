<?php
        ...
        $pagina = 'pagina' . 1 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 1, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 1 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (1 > 1) {
            echo '<a href="pagina' . (1 - 1) . '.php">Página anterior</a>';
        }
        if (1 < 100) {
            echo ' | <a href="pagina' . (1 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
