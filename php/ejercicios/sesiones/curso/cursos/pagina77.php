<?php
        ...
        $pagina = 'pagina' . 77 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 77, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 77 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (77 > 1) {
            echo '<a href="pagina' . (77 - 1) . '.php">Página anterior</a>';
        }
        if (77 < 100) {
            echo ' | <a href="pagina' . (77 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
