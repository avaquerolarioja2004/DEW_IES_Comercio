<?php
        ...
        $pagina = 'pagina' . 43 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 43, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 43 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (43 > 1) {
            echo '<a href="pagina' . (43 - 1) . '.php">Página anterior</a>';
        }
        if (43 < 100) {
            echo ' | <a href="pagina' . (43 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
