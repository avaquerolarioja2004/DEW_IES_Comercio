<?php
        ...
        $pagina = 'pagina' . 99 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 99, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 99 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (99 > 1) {
            echo '<a href="pagina' . (99 - 1) . '.php">Página anterior</a>';
        }
        if (99 < 100) {
            echo ' | <a href="pagina' . (99 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
