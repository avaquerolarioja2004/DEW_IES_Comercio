<?php
        ...
        $pagina = 'pagina' . 18 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 18, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 18 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (18 > 1) {
            echo '<a href="pagina' . (18 - 1) . '.php">Página anterior</a>';
        }
        if (18 < 100) {
            echo ' | <a href="pagina' . (18 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
