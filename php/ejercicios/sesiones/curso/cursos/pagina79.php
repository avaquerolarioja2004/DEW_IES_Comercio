<?php
        ...
        $pagina = 'pagina' . 79 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 79, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 79 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (79 > 1) {
            echo '<a href="pagina' . (79 - 1) . '.php">Página anterior</a>';
        }
        if (79 < 100) {
            echo ' | <a href="pagina' . (79 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
