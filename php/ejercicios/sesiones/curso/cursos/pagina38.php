<?php
        ...
        $pagina = 'pagina' . 38 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 38, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 38 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (38 > 1) {
            echo '<a href="pagina' . (38 - 1) . '.php">Página anterior</a>';
        }
        if (38 < 100) {
            echo ' | <a href="pagina' . (38 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
