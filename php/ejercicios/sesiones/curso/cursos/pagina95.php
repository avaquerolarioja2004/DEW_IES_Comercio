<?php
        ...
        $pagina = 'pagina' . 95 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 95, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 95 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (95 > 1) {
            echo '<a href="pagina' . (95 - 1) . '.php">Página anterior</a>';
        }
        if (95 < 100) {
            echo ' | <a href="pagina' . (95 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
