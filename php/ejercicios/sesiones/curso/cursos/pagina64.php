<?php
        ...
        $pagina = 'pagina' . 64 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 64, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 64 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (64 > 1) {
            echo '<a href="pagina' . (64 - 1) . '.php">Página anterior</a>';
        }
        if (64 < 100) {
            echo ' | <a href="pagina' . (64 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
