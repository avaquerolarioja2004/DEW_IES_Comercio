<?php
        ...
        $pagina = 'pagina' . 67 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 67, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 67 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (67 > 1) {
            echo '<a href="pagina' . (67 - 1) . '.php">Página anterior</a>';
        }
        if (67 < 100) {
            echo ' | <a href="pagina' . (67 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
