<?php
        ...
        $pagina = 'pagina' . 50 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 50, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 50 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (50 > 1) {
            echo '<a href="pagina' . (50 - 1) . '.php">Página anterior</a>';
        }
        if (50 < 100) {
            echo ' | <a href="pagina' . (50 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
