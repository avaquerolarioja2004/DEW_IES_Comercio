<?php
        ...
        $pagina = 'pagina' . 80 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 80, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 80 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (80 > 1) {
            echo '<a href="pagina' . (80 - 1) . '.php">Página anterior</a>';
        }
        if (80 < 100) {
            echo ' | <a href="pagina' . (80 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
