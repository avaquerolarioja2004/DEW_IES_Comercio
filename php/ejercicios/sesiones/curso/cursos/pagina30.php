<?php
        ...
        $pagina = 'pagina' . 30 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 30, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 30 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (30 > 1) {
            echo '<a href="pagina' . (30 - 1) . '.php">Página anterior</a>';
        }
        if (30 < 100) {
            echo ' | <a href="pagina' . (30 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
