<?php
        ...
        $pagina = 'pagina' . 61 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 61, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 61 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (61 > 1) {
            echo '<a href="pagina' . (61 - 1) . '.php">Página anterior</a>';
        }
        if (61 < 100) {
            echo ' | <a href="pagina' . (61 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
