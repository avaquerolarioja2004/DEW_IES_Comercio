<?php
        ...
        $pagina = 'pagina' . 3 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 3, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 3 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (3 > 1) {
            echo '<a href="pagina' . (3 - 1) . '.php">Página anterior</a>';
        }
        if (3 < 100) {
            echo ' | <a href="pagina' . (3 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
