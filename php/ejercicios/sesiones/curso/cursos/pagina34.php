<?php
        ...
        $pagina = 'pagina' . 34 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 34, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 34 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (34 > 1) {
            echo '<a href="pagina' . (34 - 1) . '.php">Página anterior</a>';
        }
        if (34 < 100) {
            echo ' | <a href="pagina' . (34 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
