<?php
        ...
        $pagina = 'pagina' . 11 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 11, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 11 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (11 > 1) {
            echo '<a href="pagina' . (11 - 1) . '.php">Página anterior</a>';
        }
        if (11 < 100) {
            echo ' | <a href="pagina' . (11 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
