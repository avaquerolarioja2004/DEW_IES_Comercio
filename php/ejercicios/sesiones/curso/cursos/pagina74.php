<?php
        ...
        $pagina = 'pagina' . 74 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 74, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 74 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (74 > 1) {
            echo '<a href="pagina' . (74 - 1) . '.php">Página anterior</a>';
        }
        if (74 < 100) {
            echo ' | <a href="pagina' . (74 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
