<?php
        ...
        $pagina = 'pagina' . 33 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 33, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 33 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (33 > 1) {
            echo '<a href="pagina' . (33 - 1) . '.php">Página anterior</a>';
        }
        if (33 < 100) {
            echo ' | <a href="pagina' . (33 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
