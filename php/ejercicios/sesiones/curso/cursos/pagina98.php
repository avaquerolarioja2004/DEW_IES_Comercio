<?php
        ...
        $pagina = 'pagina' . 98 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 98, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 98 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (98 > 1) {
            echo '<a href="pagina' . (98 - 1) . '.php">Página anterior</a>';
        }
        if (98 < 100) {
            echo ' | <a href="pagina' . (98 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
