<?php
        ...
        $pagina = 'pagina' . 69 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 69, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 69 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (69 > 1) {
            echo '<a href="pagina' . (69 - 1) . '.php">Página anterior</a>';
        }
        if (69 < 100) {
            echo ' | <a href="pagina' . (69 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
