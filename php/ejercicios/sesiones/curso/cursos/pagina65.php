<?php
        ...
        $pagina = 'pagina' . 65 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 65, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 65 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (65 > 1) {
            echo '<a href="pagina' . (65 - 1) . '.php">Página anterior</a>';
        }
        if (65 < 100) {
            echo ' | <a href="pagina' . (65 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
