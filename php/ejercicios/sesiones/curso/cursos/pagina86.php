<?php
        ...
        $pagina = 'pagina' . 86 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 86, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 86 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (86 > 1) {
            echo '<a href="pagina' . (86 - 1) . '.php">Página anterior</a>';
        }
        if (86 < 100) {
            echo ' | <a href="pagina' . (86 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
