<?php
        ...
        $pagina = 'pagina' . 73 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 73, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 73 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (73 > 1) {
            echo '<a href="pagina' . (73 - 1) . '.php">Página anterior</a>';
        }
        if (73 < 100) {
            echo ' | <a href="pagina' . (73 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
