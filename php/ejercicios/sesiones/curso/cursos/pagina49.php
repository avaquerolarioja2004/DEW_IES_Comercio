<?php
        ...
        $pagina = 'pagina' . 49 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 49, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 49 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (49 > 1) {
            echo '<a href="pagina' . (49 - 1) . '.php">Página anterior</a>';
        }
        if (49 < 100) {
            echo ' | <a href="pagina' . (49 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
