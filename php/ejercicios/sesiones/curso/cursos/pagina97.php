<?php
        ...
        $pagina = 'pagina' . 97 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 97, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 97 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (97 > 1) {
            echo '<a href="pagina' . (97 - 1) . '.php">Página anterior</a>';
        }
        if (97 < 100) {
            echo ' | <a href="pagina' . (97 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
