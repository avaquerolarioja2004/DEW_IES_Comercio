<?php
        ...
        $pagina = 'pagina' . 81 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 81, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 81 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (81 > 1) {
            echo '<a href="pagina' . (81 - 1) . '.php">Página anterior</a>';
        }
        if (81 < 100) {
            echo ' | <a href="pagina' . (81 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
