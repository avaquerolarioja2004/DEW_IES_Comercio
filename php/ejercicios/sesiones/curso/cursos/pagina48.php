<?php
        ...
        $pagina = 'pagina' . 48 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 48, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 48 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (48 > 1) {
            echo '<a href="pagina' . (48 - 1) . '.php">Página anterior</a>';
        }
        if (48 < 100) {
            echo ' | <a href="pagina' . (48 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
