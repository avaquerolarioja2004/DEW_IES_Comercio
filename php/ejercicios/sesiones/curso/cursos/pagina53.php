<?php
        ...
        $pagina = 'pagina' . 53 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 53, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 53 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (53 > 1) {
            echo '<a href="pagina' . (53 - 1) . '.php">Página anterior</a>';
        }
        if (53 < 100) {
            echo ' | <a href="pagina' . (53 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
