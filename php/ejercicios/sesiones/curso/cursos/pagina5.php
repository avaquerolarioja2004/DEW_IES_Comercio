<?php
        ...
        $pagina = 'pagina' . 5 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 5, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 5 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (5 > 1) {
            echo '<a href="pagina' . (5 - 1) . '.php">Página anterior</a>';
        }
        if (5 < 100) {
            echo ' | <a href="pagina' . (5 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
