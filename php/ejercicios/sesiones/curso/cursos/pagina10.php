<?php
        ...
        $pagina = 'pagina' . 10 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 10, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 10 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (10 > 1) {
            echo '<a href="pagina' . (10 - 1) . '.php">Página anterior</a>';
        }
        if (10 < 100) {
            echo ' | <a href="pagina' . (10 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
