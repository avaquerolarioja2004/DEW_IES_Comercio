<?php
        ...
        $pagina = 'pagina' . 39 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 39, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 39 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (39 > 1) {
            echo '<a href="pagina' . (39 - 1) . '.php">Página anterior</a>';
        }
        if (39 < 100) {
            echo ' | <a href="pagina' . (39 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
