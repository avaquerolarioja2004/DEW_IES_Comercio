<?php
        ...
        $pagina = 'pagina' . 21 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 21, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 21 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (21 > 1) {
            echo '<a href="pagina' . (21 - 1) . '.php">Página anterior</a>';
        }
        if (21 < 100) {
            echo ' | <a href="pagina' . (21 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
