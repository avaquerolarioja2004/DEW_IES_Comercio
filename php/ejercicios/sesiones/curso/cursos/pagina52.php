<?php
        ...
        $pagina = 'pagina' . 52 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 52, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 52 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (52 > 1) {
            echo '<a href="pagina' . (52 - 1) . '.php">Página anterior</a>';
        }
        if (52 < 100) {
            echo ' | <a href="pagina' . (52 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
