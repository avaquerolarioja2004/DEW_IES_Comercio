<?php
        ...
        $pagina = 'pagina' . 78 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 78, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 78 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (78 > 1) {
            echo '<a href="pagina' . (78 - 1) . '.php">Página anterior</a>';
        }
        if (78 < 100) {
            echo ' | <a href="pagina' . (78 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
