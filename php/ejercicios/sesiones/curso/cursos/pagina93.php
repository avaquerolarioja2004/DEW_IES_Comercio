<?php
        ...
        $pagina = 'pagina' . 93 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 93, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 93 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (93 > 1) {
            echo '<a href="pagina' . (93 - 1) . '.php">Página anterior</a>';
        }
        if (93 < 100) {
            echo ' | <a href="pagina' . (93 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
