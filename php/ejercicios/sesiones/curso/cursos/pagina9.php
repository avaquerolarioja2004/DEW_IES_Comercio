<?php
        ...
        $pagina = 'pagina' . 9 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 9, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 9 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (9 > 1) {
            echo '<a href="pagina' . (9 - 1) . '.php">Página anterior</a>';
        }
        if (9 < 100) {
            echo ' | <a href="pagina' . (9 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
