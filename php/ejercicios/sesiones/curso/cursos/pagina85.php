<?php
        ...
        $pagina = 'pagina' . 85 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 85, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 85 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (85 > 1) {
            echo '<a href="pagina' . (85 - 1) . '.php">Página anterior</a>';
        }
        if (85 < 100) {
            echo ' | <a href="pagina' . (85 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
