<?php
        ...
        $pagina = 'pagina' . 17 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 17, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 17 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (17 > 1) {
            echo '<a href="pagina' . (17 - 1) . '.php">Página anterior</a>';
        }
        if (17 < 100) {
            echo ' | <a href="pagina' . (17 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
