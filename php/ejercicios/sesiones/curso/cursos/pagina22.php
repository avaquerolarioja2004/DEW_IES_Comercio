<?php
        ...
        $pagina = 'pagina' . 22 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 22, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 22 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (22 > 1) {
            echo '<a href="pagina' . (22 - 1) . '.php">Página anterior</a>';
        }
        if (22 < 100) {
            echo ' | <a href="pagina' . (22 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
