<?php
        ...
        $pagina = 'pagina' . 84 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 84, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 84 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (84 > 1) {
            echo '<a href="pagina' . (84 - 1) . '.php">Página anterior</a>';
        }
        if (84 < 100) {
            echo ' | <a href="pagina' . (84 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
