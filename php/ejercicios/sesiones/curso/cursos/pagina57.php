<?php
        ...
        $pagina = 'pagina' . 57 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 57, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 57 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (57 > 1) {
            echo '<a href="pagina' . (57 - 1) . '.php">Página anterior</a>';
        }
        if (57 < 100) {
            echo ' | <a href="pagina' . (57 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
