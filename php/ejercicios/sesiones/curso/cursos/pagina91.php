<?php
        ...
        $pagina = 'pagina' . 91 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 91, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 91 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (91 > 1) {
            echo '<a href="pagina' . (91 - 1) . '.php">Página anterior</a>';
        }
        if (91 < 100) {
            echo ' | <a href="pagina' . (91 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
