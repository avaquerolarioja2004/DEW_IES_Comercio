<?php
        ...
        $pagina = 'pagina' . 96 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 96, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 96 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (96 > 1) {
            echo '<a href="pagina' . (96 - 1) . '.php">Página anterior</a>';
        }
        if (96 < 100) {
            echo ' | <a href="pagina' . (96 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
