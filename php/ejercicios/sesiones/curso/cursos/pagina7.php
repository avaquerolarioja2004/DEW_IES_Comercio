<?php
        ...
        $pagina = 'pagina' . 7 . '.php';  // La página actual
        ...
        actualizarUltimaPagina($usuario, 7, $usuarios, $usuarioFile);

        echo '<h2>Bienvenido a la página 7 del curso</h2>';
        echo '<a href="../logout.php">Cerrar sesión</a>';

        // Enlaces de navegación
        echo '<p>';
        if (7 > 1) {
            echo '<a href="pagina' . (7 - 1) . '.php">Página anterior</a>';
        }
        if (7 < 100) {
            echo ' | <a href="pagina' . (7 + 1) . '.php">Página siguiente</a>';
        }
        echo '</p>';
